...
@section('contenidoPrincipal')
    <div class="politica bg-light border-4 rounded-3">
        <h5 class="card-header text-white bg-secondary fw-bold mb-3">POLÍTICA DE PRIVACIDAD</h5>

        <p class="text-start">
            La presente Política de Privacidad establece los términos en que GESTIFACIL usa y protege la información que
            es proporcionada por sus usuarios al momento de utilizar su sitio web. Esta compañía está comprometida con
            la seguridad de los datos de sus usuarios. Cuando le pedimos llenar los campos de información personal con
            ...
            lo que le recomendamos y enfatizamos revisar continuamente esta página para asegurarse que está de acuerdo
            con dichos cambios.
        </p>
        ...
        <p class="text-start">
            ...
            GESTIFACIL está altamente comprometido para cumplir con el compromiso de mantener su información segura.
        ...
        <p class="text-start">
            ...
            GESTIFACIL se reserva el derecho de cambiar los términos de la presente Política de Privacidad en cualquier
            momento.
        </p>
